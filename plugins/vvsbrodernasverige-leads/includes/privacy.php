...
add_filter(
	...
	function ( $exporters ) {
		$exporters['vvsbrodernasverige-leads'] = array(
			'exporter_friendly_name' => __( 'Quote requests', 'vvsbrodernasverige-leads' ),
			'callback'               => function ( $email ) {
				$items = array();
				foreach ( npl_leads_by_email( $email ) as $lead ) {
					$data = array( array( 'name' => __( 'Received', 'vvsbrodernasverige-leads' ), 'value' => $lead->post_date ) );
					...
					$items[] = array(
						'group_id'    => 'vvsbrodernasverige-leads',
						'group_label' => __( 'Quote requests', 'vvsbrodernasverige-leads' ),
...
add_filter(
	...
	function ( $erasers ) {
		$erasers['vvsbrodernasverige-leads'] = array(
			'eraser_friendly_name' => __( 'Quote requests', 'vvsbrodernasverige-leads' ),
			'callback'             => function ( $email ) {
				$removed = false;
				foreach ( npl_leads_by_email( $email ) as $lead ) {
