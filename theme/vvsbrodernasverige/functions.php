<?php
/**
 * VVS Bröderna Sverige AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "VVS Bröderna Sverige AB Leads" plugin, so leads survive a theme change.
 *
 ...
 * Patterns read these through vv_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'vvsbrodernasverige', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'vvsbrodernasverige' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'vvsbrodernasverige' ) ) );

		register_block_pattern_category( 'vvsbrodernasverige-sections', array( 'label' => __( 'VVS Bröderna Sverige AB sections', 'vvsbrodernasverige' ) ) );
		register_block_pattern_category( 'vvsbrodernasverige-pages', array( 'label' => __( 'VVS Bröderna Sverige AB page layouts', 'vvsbrodernasverige' ) ) );
	}
);
